...
inputFilePath = boinc.resolve_filename(args[0])
statesFilePath = boinc.resolve_filename(options.statesFile)
carsFilePath = boinc.resolve_filename(options.carsFile)
...
tar = tarfile.open(boinc.resolve_filename("data.tar.bz2"), "w:bz2")
